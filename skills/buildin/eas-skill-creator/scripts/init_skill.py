...
def load_skill_template():
    """Load the skill template from external file."""
    template_path = Path(__file__).parent / "skill-template.txt"
    try:
        return template_path.read_text(encoding='utf-8')
    except Exception as e:
        print(f"Error reading skill template: {e}")
...
SKILL_TEMPLATE = load_skill_template()
