#!/usr/bin/env bash
# make.sh — easbot-pdf unified CLI
...
[
  ...
  {"type":"body",    "text":"This document was generated by easbot-pdf — a skill for creating visually polished PDFs. Every design decision is rooted in the document type and content, not a generic template."},
...
JSON
  ...
  cmd_run \
    --title   "easbot-pdf demo" \
    --type    "report" \
    --author  "easbot-pdf skill" \
    --date    "$(date '+%B %Y')" \
