...
python3 <skillPath>/scripts/formula_check.py output.xlsx
```
...
python3 <skillPath>/scripts/xlsx_shift_rows.py /tmp/xlsx_work/ insert 5 1

# Delete 1 row at row 8: all rows 9 and above shift up by 1
python3 <skillPath>/scripts/xlsx_shift_rows.py /tmp/xlsx_work/ delete 8 1
```
...
python3 <skillPath>/scripts/libreoffice_recalc.py output.xlsx /tmp/recalc.xlsx
python3 <skillPath>/scripts/formula_check.py /tmp/recalc.xlsx
```
