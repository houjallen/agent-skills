...
```bash
python3 <skillPath>/scripts/xlsx_reader.py input.xlsx                 # full report
python3 <skillPath>/scripts/xlsx_reader.py input.xlsx --sheet Sales   # single sheet
python3 <skillPath>/scripts/xlsx_reader.py input.xlsx --quality       # quality audit only
python3 <skillPath>/scripts/xlsx_reader.py input.xlsx --json          # machine-readable
```
